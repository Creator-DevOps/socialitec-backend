...
Revision ID: 61310209ba30
Revises: 
Create Date: 2025-05-08 13:53:14.099627
...
def upgrade():
    ...
    op.create_table('report_cycle_item',
    ...
    sa.Column('start_date', sa.Date(), nullable=False),
    sa.Column('end_date', sa.Date(), nullable=False),
    sa.ForeignKeyConstraint(['cycle_id'], ['report_cycle.cycle_id'], ),
    ...
    sa.ForeignKeyConstraint(['coordinator_id'], ['coordinator.user_id'], ),
    sa.ForeignKeyConstraint(['document_id'], ['document.document_id'], ),
    sa.ForeignKeyConstraint(['item_id'], ['report_cycle_item.item_id'], ),
    sa.ForeignKeyConstraint(['request_id'], ['request.request_id'], ),
    sa.PrimaryKeyConstraint('document_id')
    )
...
def downgrade():
    ...
    op.drop_table('report_cycle_item')
    op.drop_table('program')
    op.drop_table('coordinator')
    op.drop_table('admin')
    op.drop_table('user')
    op.drop_table('report_cycle')
